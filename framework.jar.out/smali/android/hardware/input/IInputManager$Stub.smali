...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 43
    :sswitch_0
    const-string/jumbo v27, "android.hardware.input.IInputManager"
    ...
    .line 52
    .local v21, "_result":Landroid/view/InputDevice;
    ...
    .end local v21    # "_result":Landroid/view/InputDevice;
    :sswitch_2
    const-string/jumbo v27, "android.hardware.input.IInputManager"
    ...
    .line 107
    sget-object v27, Landroid/view/InputEvent;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {v0, v6, v9}, Landroid/hardware/input/IInputManager$Stub;->injectInputEvent(Landroid/view/InputEvent;I)Z
    ...
    invoke-virtual {v0, v7, v9}, Landroid/hardware/input/IInputManager$Stub;->getTouchCalibrationForInputDevice(Ljava/lang/String;I)Landroid/hardware/input/TouchCalibration;

    move-result-object v20

    .line 127
    .local v20, "_result":Landroid/hardware/input/TouchCalibration;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v9    # "_arg1":I
    .end local v20    # "_result":Landroid/hardware/input/TouchCalibration;
    :sswitch_7
    const-string/jumbo v27, "android.hardware.input.IInputManager"
    ...
    .line 146
    sget-object v27, Landroid/hardware/input/TouchCalibration;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {v0, v7, v9, v14}, Landroid/hardware/input/IInputManager$Stub;->setTouchCalibrationForInputDevice(Ljava/lang/String;ILandroid/hardware/input/TouchCalibration;)V
    ...
    .line 169
    .local v19, "_result":Landroid/hardware/input/KeyboardLayout;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 181
    .end local v7    # "_arg0":Ljava/lang/String;
    .end local v19    # "_result":Landroid/hardware/input/KeyboardLayout;
    :sswitch_a
    const-string/jumbo v27, "android.hardware.input.IInputManager"
    ...
    .line 184
    sget-object v27, Landroid/hardware/input/InputDeviceIdentifier;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {v0, v5, v11}, Landroid/hardware/input/IInputManager$Stub;->setCurrentKeyboardLayoutForInputDevice(Landroid/hardware/input/InputDeviceIdentifier;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5, v11}, Landroid/hardware/input/IInputManager$Stub;->addKeyboardLayoutForInputDevice(Landroid/hardware/input/InputDeviceIdentifier;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5, v11}, Landroid/hardware/input/IInputManager$Stub;->removeKeyboardLayoutForInputDevice(Landroid/hardware/input/InputDeviceIdentifier;Ljava/lang/String;)V
    ...
    invoke-static/range {v27 .. v27}, Landroid/hardware/input/IInputDevicesChangedListener$Stub;->asInterface(Landroid/os/IBinder;)Landroid/hardware/input/IInputDevicesChangedListener;
    ...
    invoke-virtual {v0, v8}, Landroid/hardware/input/IInputManager$Stub;->switchTouchSensitiveMode(Z)V
    ...
    invoke-virtual {v0, v8}, Landroid/hardware/input/IInputManager$Stub;->switchTouchStylusMode(Z)V
    ...
    invoke-virtual {v0, v8}, Landroid/hardware/input/IInputManager$Stub;->switchTouchWakeupMode(Z)V
