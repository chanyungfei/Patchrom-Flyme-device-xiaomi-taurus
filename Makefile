...
vendor_saved_apps := Bluetooth KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     ...
                     ProxyHandler Shell DefaultContainerService Camera2 Stk TimeService
...
#-----------------------------------------------------------------------------
board_saved_files := lib/libwebviewchromium.so bin/bootanimation bin/shutdownanimation media/shutanimation.zip
